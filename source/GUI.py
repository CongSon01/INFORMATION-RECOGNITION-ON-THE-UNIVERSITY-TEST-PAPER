...
############# INITIAL CONFIG ################
with open('E:\WorkSpace\Computer Vision\Automated-scoring-of-handwritten-test-papers-main\data\scoreList.txt', "r", encoding="utf-8") as f:
    reader = f.read()
...
#word_model.summary()
word_model_dir = "..\model\model_word\word_model\word_model_last_6.h5"
...
#digit_model.summary()
digit_model_dir = '..\model\multi_digit_model\digit_model\digit_model_last_2021-11-26.h5'
...
def btnStart():
    ...
    datas = ['giaythi7.jpg', 'giaythi8.jpg', 'giaythi9.jpg']
    ...
    while(flat):
        ...
        print("XET: ", datas[stop])
        link_url = URL_path + datas[stop]
        img = cv2.imread(link_url)
        ...
        # print("MSSV_crop", MSSV_crop)
        # print("name_crop", name_crop)
        # print("diem_crop", diem_crop)
        if name_crop == []:
...
def browseFiles():
    ...
    class_list_dir = filedialog.askopenfilename(parent=window,
        initialdir = "E:/WorkSpace/Computer Vision/Automated-scoring-of-handwritten-test-papers-main/data/",
                                          title = "Select a File",
                                          filetypes = (("Excel files",
                                                        "*.xlsx*"),
                                                       ("all files",
                                                        "*.*")))
    root_dir= 'E:/WorkSpace/Computer Vision/Automated-scoring-of-handwritten-test-papers-main/'
...
lbl = tkinter.Label(window, text="Sinh viên: Dương Công Sơn", fg="black", font=("Arial", 20))
lbl.grid(column=0, row=4)

lbl = tkinter.Label(window, text="MSSV: 167464", fg="black", font=("Arial", 20))
